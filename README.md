...
Accepts a `.txt` file and provides analysis on number of words and the count of characters, a sample text can be found [here](https://raw.githubusercontent.com/asweigart/codebreaker/master/frankenstein.txt). Please drop the text into a `/books` directory if running
